...
<p><a href="resources/MS_CFMP.pdf"><strong>A Four-Modality Fusion Method of Crowdfunding Prediction</strong></a> <button type="button" class="button-preprint">preprint</button> <br />
...
<p><a href="resources/MS_Onlinetrust.pdf"><strong>Do online trust in crowdfunding effects investment decisions?</strong></a> <button type="button" class="button-preprint">preprint</button>  <br />
<strong>Zijian ZHANG</strong>      <br />
...
crowdfunding success</strong></a> <button type="button" class="button-preprint">preprint</button>  <br />
<strong>Zijian ZHANG</strong>      <br />
